...
class AdminsController < ApplicationController
  ...
  def invite
    ...
    emails.each do |email|
      ...
      send_invitation_email(current_user.full_name, email, invitation.invite_token)
    end
  ...
  def update_plan
    ...
    @plan.update(plan_params) if @plan.present?
  ...
  def plan_params
    params.require(:plan).permit(:unit_amount)
  end
end
